...
def test_scanner_state_and_activity_are_durable() -> None:
    engine, repo = _repository()
    try:
        repo.mark_scan_started("provider-1", "alt.binaries.audiobooks")
